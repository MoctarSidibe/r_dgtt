 ...
 * 
 * Cette entité stocke toutes les informations relatives à un candidat
 * incluant ses évaluations, paiements, et documents.
 */
@Entity
...
public class Candidat {
    ...
    public boolean isEvaluationComplete() {
        return evaluations.stream().allMatch(Evaluation::isComplete);
    }
    ...
    public boolean peutPasserExamen() {
        return statut == StatutCandidat.PRE_ENROLE && isPaiementEffectue() && 
               isEvaluationComplete() && isDocumentsComplets();
    }
    ...
    public List<DocumentCandidat> getDocuments() { return documents; }
    public void setDocuments(List<DocumentCandidat> documents) { this.documents = documents; }
