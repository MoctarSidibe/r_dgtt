...
/**
 * Entité représentant un document d'auto-école
 * 
 * Cette entité stocke les informations sur les documents joints
 * lors de la demande d'ouverture d'une auto-école.
 */
@Entity
@Table(name = "documents_auto_ecole")
@EntityListeners(AuditingEntityListener.class)
public class DocumentAutoEcole {
    ...
    private TypeDocumentAutoEcole typeDocument;
    ...
    // Constructeurs
    public DocumentAutoEcole() {}
    
    public DocumentAutoEcole(AutoEcole autoEcole, TypeDocumentAutoEcole typeDocument, 
    ...
    public TypeDocumentAutoEcole getTypeDocument() { return typeDocument; }
    public void setTypeDocument(TypeDocumentAutoEcole typeDocument) { this.typeDocument = typeDocument; }
